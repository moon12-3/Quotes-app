...
class QuoteEditAdapter(private val dataList : List<Quote>) : RecyclerView.Adapter<QuoteEditAdapter.QuoteItemViewHolder>(){
    ...
    class QuoteItemViewHolder(val view : View) : RecyclerView.ViewHolder(view){
        ...
        init {
            ...
            quoteDeleteBtn.setOnClickListener {
                ...
                quote.text = ""
                quote.from = ""
                Quote.removeQuoteFromPreferences(pref, adapterPosition)
                Toast.makeText(it.context, "삭제하였습니다.", Toast.LENGTH_SHORT).show()
            }
            ...
            quoteModifyBtn.setOnClickListener {
                ...
                Toast.makeText(it.context, "수정하였습니다.", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    override fun getItemViewType(position: Int): Int = R.layout.quote_edit_item
}